      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#modif">Nouveau compte</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Création d'un nouveau compte</h2>
            <h3 class="section-subheading text-muted">Remplissez les champs avec les informations correspondantes</h3>
          </div>
        </div>
