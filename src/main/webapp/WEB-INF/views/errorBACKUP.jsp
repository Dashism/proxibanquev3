      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Félicitations, vous êtes responsable du nouveau crash boursier</h2>
            <h3 class="section-subheading text-muted">Bon, d'accord, pas vraiment. Mais il y a quand même une erreur quelque part, donc veuillez contacter le responsable technique pour la résoudre.</h3>
          </div>
        </div>
        <div class="row">
        <div class="col-sm-4">
