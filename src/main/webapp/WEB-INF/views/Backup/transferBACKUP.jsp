      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#modif">Virement</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Veuillez choisr les comptes à débiter et à créditr, ainsi que le montant du virement</h3>
          </div>
        </div>
	<c:if test="${accounts.size()<2}">
	<div>
		<p>Vous n'avez pas assez de comptes pour faire un virement compte à compte.</p>
	</div>
	</c:if>
	<c:if test="${accounts.size()>=2}">
